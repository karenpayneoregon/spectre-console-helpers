...
namespace SelectiveUpdatesApp
{
    internal partial class Program
    {
        ...
        private static void ShouldLastNameBeUpdated()
        {
            ...
            AnsiConsole.MarkupLine($"[cyan]Done[/] [yellow]{nameof(ShouldLastNameBeUpdated)}[/]");
            Console.WriteLine();
        }
        ...
        private static void OnlyUpdateFirstName()
        {
            ...
            AnsiConsole.MarkupLine($"[cyan]Done[/] [yellow]{nameof(OnlyUpdateFirstName)}[/]");
            Console.WriteLine();
        }
        ...
        private static void DataTransferUpdate(int id, PersonDto sender)
        {
            ...
            AnsiConsole.MarkupLine($"[cyan]Done[/] [yellow]{nameof(DataTransferUpdate)}[/]");
